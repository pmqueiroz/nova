...
| Platform | Download |
|----------|----------|
| Windows x86_64 | [`.exe` installer](https://github.com/pmqueiroz/nova/releases/download/v0.12.3/nova_0.12.3_x64-setup.exe) · [portable `.zip`](https://github.com/pmqueiroz/nova/releases/download/v0.12.3/nova_0.12.3_x64_portable.zip) |
| macOS x86_64 | [`.dmg` disk image](https://github.com/pmqueiroz/nova/releases/download/v0.12.3/nova_0.12.3_x64.dmg) |
| macOS Apple Silicon | [`.dmg` disk image](https://github.com/pmqueiroz/nova/releases/download/v0.12.3/nova_0.12.3_aarch64.dmg) |
| Linux x86_64 | [`.deb`](https://github.com/pmqueiroz/nova/releases/download/v0.12.3/nova_0.12.3_amd64.deb) · [`.AppImage`](https://github.com/pmqueiroz/nova/releases/download/v0.12.3/nova_0.12.3_x86_64.AppImage) · [`.rpm`](https://github.com/pmqueiroz/nova/releases/download/v0.12.3/nova_0.12.3_x86_64.rpm) |

Each release includes a [`checksums.txt`](https://github.com/pmqueiroz/nova/releases/download/v0.12.3/checksums.txt) for verifying the download.
