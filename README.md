...
| Platform | Download |
|----------|----------|
| Windows x86_64 | [`.exe` installer](https://github.com/pmqueiroz/nova/releases/download/v0.19.0/nova_0.19.0_x64-setup.exe) · [portable `.zip`](https://github.com/pmqueiroz/nova/releases/download/v0.19.0/nova_0.19.0_x64_portable.zip) |
| macOS x86_64 | [`.dmg` disk image](https://github.com/pmqueiroz/nova/releases/download/v0.19.0/nova_0.19.0_x64.dmg) |
| macOS Apple Silicon | [`.dmg` disk image](https://github.com/pmqueiroz/nova/releases/download/v0.19.0/nova_0.19.0_aarch64.dmg) |
| Linux x86_64 | [`.deb`](https://github.com/pmqueiroz/nova/releases/download/v0.19.0/nova_0.19.0_amd64.deb) · [`.AppImage`](https://github.com/pmqueiroz/nova/releases/download/v0.19.0/nova_0.19.0_x86_64.AppImage) · [`.rpm`](https://github.com/pmqueiroz/nova/releases/download/v0.19.0/nova_0.19.0_x86_64.rpm) |

Each release includes a [`checksums.txt`](https://github.com/pmqueiroz/nova/releases/download/v0.19.0/checksums.txt) for verifying the download.
